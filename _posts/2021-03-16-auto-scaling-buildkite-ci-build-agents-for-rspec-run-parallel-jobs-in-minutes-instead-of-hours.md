...
Please note that you should hide your credentials like the Knapsack Pro API token and don't commit it into your repository. You can see [Buildkite secrets documentation](https://buildkite.com/docs/pipelines/secrets).
