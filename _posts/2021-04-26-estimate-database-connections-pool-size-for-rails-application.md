...
Assuming you use 2 threads per Puma process, it's good to have the `pool` option set to 2 + some spare connections. It allows ActiveRecord to open a new connection if one of the DB connections is dead.
...
If you are looking to improve your Rails application workflow please consider checking how to [run automated tests in parallel on your CI server](/2020/how-to-speed-up-ruby-and-javascript-tests-with-ci-parallelisation) with [Knapsack Pro](https://knapsackpro.com/?utm_source=docs_knapsackpro&utm_medium=blog_post&utm_campaign=estimate-database-connections-pool-size-for-rails-application).
