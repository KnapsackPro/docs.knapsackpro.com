...
When using `minitest-spec-rails`, avoid the [unsupported *outer describe*](https://github.com/metaskills/minitest-spec-rails). Otherwise, Knapsack Pro won't be able to track the execution time of each test.
