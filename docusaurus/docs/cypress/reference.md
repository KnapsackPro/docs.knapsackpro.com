...
Since v10, [`KNAPSACK_PRO_TEST_QUEUE_ID`](#knapsack_pro_test_queue_id) is used instead.
...
Since v10, this ENV is ignored. See [Retry only Failures](retry-only-failures.md) for details.
